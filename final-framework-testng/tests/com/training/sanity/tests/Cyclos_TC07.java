...
public class Cyclos_TC07 {
	...
	@Test(dependsOnMethods = { "validHomeTest" })
	public void changePasswordTest() {
		screenShot.captureScreenShot();

		changePassword.enterOldPassword("passw0rd");
		changePassword.enterNewPassword("abc");
		changePassword.enterconfirmPassword("123");
		changePassword.clickSubmit();
		changePassword.assertAlertForWrongPassword(driver);
		screenShot.captureScreenShot();
		changePassword.assertPasswordPage();
